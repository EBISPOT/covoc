 ...
 * [covoc.yml](covoc.yml)
     * Determines how your purl.obolibrary.org/obo/covoc/ redirects will be handled
     ...
     * Paste in the contents of [covoc.yml](covoc.yml)
 ...
 * [covoc.md](covoc.md)
     ...
     * Paste in the contents of [covoc.md](covoc.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
